---
name: open-dossier
description: Turn any project folder into a source-driven knowledge dossier that compounds over time — ingest documents into traceable analyses, a living wiki, plans, actions and decisions. Use this skill whenever the user wants to process source documents (reports, transcripts, emails, decks, papers) into structured knowledge; asks to "ingest", "process" or "verwerk" a document; wants a knowledge base, wiki or "second brain" for a project; wants plans and action items derived from documents and traceable to their source; asks what a dossier knows ("query the dossier", "what do we know about X"); or asks for a health check of the knowledge base. Also trigger on mentions of "dossier", "source-driven", "bronregister", "LLM wiki", or maintaining a decision log / action register from meeting notes.
license: MIT
---
